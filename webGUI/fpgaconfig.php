...
<ul>
    ...
    <li id="activelink"><a href="fpgaconfig.php">FPGAconfig</a></li>
...
<form action="action_fpgaconfig.php" method=post  target="my_iframe">
<br><br><br><br>
<input type="radio" name="image" value="1" >Load to image 1 (golden)
<br><br>
<input type="radio" name="image" value="2">Load to image 2 (user)
<br><br>
<input type="radio" name="jump" value="1" >Jump to image 1 (golden)
<br><br>
<input type="radio" name="jump" value="2">Jump to image 2 (user)
<br><br>
FPGA Bitstream (*.mcs format): <input type="textfield" name="bitstream">
...
<?php 
   ...
   if (isset($_GET["STOP"]))
   {
      shell_exec("kill $(pidof fpgaconfig)");
...
<script type="text/javascript" ></script>
    <script>
      $(document).ready(function(){
        var locations = ["", "action_fpgaconfig.php"];
