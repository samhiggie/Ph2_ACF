...
<ul>
    ...
    <li id="activelink"><a href="datatest.php">Datatest</a></li>
...
<form action="action_datatest.php" method=post  target="my_iframe">

<input type="checkbox" name="ignoreI2c" value="yes" >Ignore I2c
<br><br>
<input type="checkbox" name="parallel" value="yes">Acquisition running in a separate thread
<br><br>
<input type="checkbox" name="save" value="yes">Save data to a row file
<br><br>
Treshold in Vcth units:<input type="textfield" name="vcth" >
<br><br>
Hw Description File:<input type="textfield" name="Hw Description File " value="settings/Calibration2CBC.xml">
<br><br>
Number of events:<input type="textfield" name="events" >
<br><br>
...
<?php 
   ...
   if (isset($_GET["STOP"]))
   {
      shell_exec("kill $(pidof datatest)");
...
<script type="text/javascript" ></script>
    <script>
      $(document).ready(function(){
        var locations = ["", "action_datateast.php"];
